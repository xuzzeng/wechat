...
use Interfaces\Common\SHA1;
use Interfaces\Common\PKCS7Encoder;
use Interfaces\Common\xmlparse;
use Interfaces\Common\errorCode;
use Interfaces\Common\Prpcrypt;
use \Think\Log;
/**
 * 1.第三方回复加密消息给公众平台；
...
class WXBizMsgCrypt
{
	 ...
	 */
	public function set($token, $encodingAesKey, $Corpid)
	{                 
	...
	*/
	public function VerifyURL($sMsgSignature, $sTimeStamp, $sNonce, $sEchoStr, &$sReplyEchoStr)
	{
		...
		$signature = $array[1];
                                       Log::write("生成的signature:".$signature);
                                       Log::write("微信传递过来的signature:".$sMsgSignature);
